...
function passwordOptions (){
  var passwordLink = prompt('How many character would you like in your password!');
  var numberConfirm = confirm('click od to confirm including your numeric character.');
  var specialConfirm = confirm('click to confirm including your special character');
